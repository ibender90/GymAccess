...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/api/v1/workout/**").hasRole(COACH.name())
                .requestMatchers(GET, "/api/v1/workout/**").hasAuthority(COACH_READ.name())
                .requestMatchers(POST, "/api/v1/workout/**").hasAuthority(COACH_CREATE.name())
                .requestMatchers(PUT, "/api/v1/workout/**").hasAuthority(COACH_UPDATE.name())
                .requestMatchers(DELETE, "/api/v1/workout/**").hasAuthority(COACH_DELETE.name())
